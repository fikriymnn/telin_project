...
class AddNewItemSmall extends StatefulWidget {
  const AddNewItemSmall({super.key});

  @override
  State<AddNewItemSmall> createState() => _AddNewItemSmallState();
}

class _AddNewItemSmallState extends State<AddNewItemSmall> {
