...
class AddNewKitLarge extends StatefulWidget {
  const AddNewKitLarge({super.key});

  @override
  State<AddNewKitLarge> createState() => _AddNewKitLargeState();
}

class _AddNewKitLargeState extends State<AddNewKitLarge> {
