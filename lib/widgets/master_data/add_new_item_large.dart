...
class AddNewItemLarge extends StatefulWidget {
  const AddNewItemLarge({super.key});

  @override
  State<AddNewItemLarge> createState() => _AddNewItemLargeState();
}

class _AddNewItemLargeState extends State<AddNewItemLarge> {
