                ...
                child: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "(Available ${widget.initialLength})",
                        style: GoogleFonts.rubik(
                          fontSize: 19,
                          fontWeight: FontWeight.w500,
              ...
              Padding(
                ...
                child: Center(
                    child: CustomTextField(
                        controller: _length,
                        label: "Input Length Returned (Meter)")),
              ),
              const SizedBox(
                height: 10,
              ),
                      ...
                      onTap: () {
                        if (_length == "") {
                          QuickAlert.show(
                              ...
                              title: 'Peringatan',
                              text: 'Length Tidak Boleh Kosong',
                              width: 400,
                              confirmBtnColor: Colors.red);
                        } else {
                          doOffLoadingExisting(widget.idCable,
                              widget.idOffLoading, "idr", "usd", _length.text);
