...
class TableCableExisting extends StatefulWidget {
  const TableCableExisting({super.key, required this.idLoading});
  final String idLoading;

  @override
  State<TableCableExisting> createState() => _TableCableExistingState();
}
...
class _TableCableExistingState extends State<TableCableExisting> {
