...
class TableRakB1 extends StatefulWidget {
  const TableRakB1({super.key});

  @override
  State<TableRakB1> createState() => _TableRakB1State();
}

class _TableRakB1State extends State<TableRakB1> {
  List rakB1 = [];
  ...
  void getDataRakB1() async {
    try {
      response = await dio.get(getRakB1);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DataTable2(
          ...
          rows: List.generate(
              rakB1.length, (index) => _resultsAPI(index, rakB1[index]))),
    );
  }
}
