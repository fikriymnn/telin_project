...
class TableRakA6 extends StatefulWidget {
  const TableRakA6({super.key});

  @override
  State<TableRakA6> createState() => _TableRakA6State();
}

class _TableRakA6State extends State<TableRakA6> {
  List rakA6 = [];
  ...
  void getDataRakA6() async {
    try {
      response = await dio.get(getRakA6);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DataTable2(
          ...
          rows: List.generate(
              rakA6.length, (index) => _resultsAPI(index, rakA6[index]))),
    );
  }
}
