...
class TableRakA4 extends StatefulWidget {
  const TableRakA4({super.key});

  @override
  State<TableRakA4> createState() => _TableRakA4State();
}

class _TableRakA4State extends State<TableRakA4> {
  List rakA4 = [];
  ...
  void getDataRakA4() async {
    try {
      response = await dio.get(getRakA4);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DataTable2(
          ...
          rows: List.generate(
              rakA4.length, (index) => _resultsAPI(index, rakA4[index]))),
    );
  }
}
