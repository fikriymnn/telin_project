...
class TableRakB2 extends StatefulWidget {
  const TableRakB2({super.key});

  @override
  State<TableRakB2> createState() => _TableRakB2State();
}

class _TableRakB2State extends State<TableRakB2> {
  List rakB2 = [];
  ...
  void getDataRakB2() async {
    try {
      response = await dio.get(getRakB2);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DataTable2(
          ...
          rows: List.generate(
              rakB2.length, (index) => _resultsAPI(index, rakB2[index]))),
    );
  }
}
