...
class TableRakB6 extends StatefulWidget {
  const TableRakB6({super.key});

  @override
  State<TableRakB6> createState() => _TableRakB6State();
}

class _TableRakB6State extends State<TableRakB6> {
  List rakB6 = [];
  ...
  void getDataRakB6() async {
    try {
      response = await dio.get(getRakB6);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DataTable2(
          ...
          rows: List.generate(
              rakB6.length, (index) => _resultsAPI(index, rakB6[index]))),
    );
  }
}
