...
class TableRakA5 extends StatefulWidget {
  const TableRakA5({super.key});

  @override
  State<TableRakA5> createState() => _TableRakA5State();
}

class _TableRakA5State extends State<TableRakA5> {
  List rakA5 = [];
  ...
  void getDataRakA5() async {
    try {
      response = await dio.get(getRakA5);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DataTable2(
          ...
          rows: List.generate(
              rakA5.length, (index) => _resultsAPI(index, rakA5[index]))),
    );
  }
}
