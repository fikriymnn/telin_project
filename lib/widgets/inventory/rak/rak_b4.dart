...
class TableRakB4 extends StatefulWidget {
  const TableRakB4({super.key});

  @override
  State<TableRakB4> createState() => _TableRakB4State();
}

class _TableRakB4State extends State<TableRakB4> {
  List rakB4 = [];
  ...
  void getDataRakB4() async {
    try {
      response = await dio.get(getRakB4);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DataTable2(
          ...
          rows: List.generate(
              rakB4.length, (index) => _resultsAPI(index, rakB4[index]))),
    );
  }
}
