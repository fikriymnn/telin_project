                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank6[index]['label_id'] == null ? "" : tank6[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank6[index]['system'] == null ? "" : tank6[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank6[index]['armoring_type'] == null ? "" : tank6[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank6[index]['cable_type'] == null ? "" : tank6[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank6[index]['manufacturer'] == null ? "" : tank6[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank6[index]['length_report'] == null ? "" : tank6[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank6[index]['core_type'] == null ? "" : tank6[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank6[index]['core'] == null ? "" : tank6[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank6[index]['tank'] == null ? "" : tank6[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank6[index]['tank_location'] == null ? "" : tank6[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank6[index]['tank_level'] == null ? "" : tank6[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank6[index]['remark'] == null ? "" : tank6[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank6[index]['description'] == null ? "" : tank6[index]['description']}'),
                    },
                  ),
                ),
