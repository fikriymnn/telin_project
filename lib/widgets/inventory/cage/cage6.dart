...
class TableCage6 extends StatefulWidget {
  const TableCage6({super.key});

  @override
  State<TableCage6> createState() => _TableCage6State();
}

class _TableCage6State extends State<TableCage6> {
  List cage6 = [];
  ...
  void getDatareCage6() async {
    try {
      response = await dio.get(getCage6);
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: DataTable2(
          ...
          rows: List.generate(
              cage6.length, (index) => _resultsAPI(index, cage6[index])),
        ));
  }
}
