...
class TableCage2 extends StatefulWidget {
  const TableCage2({super.key});

  @override
  State<TableCage2> createState() => _TableCage2State();
}

class _TableCage2State extends State<TableCage2> {
  List cage2 = [];
  ...
  void getDatareCage2() async {
    try {
      response = await dio.get(getCage2);
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: DataTable2(
          ...
          rows: List.generate(
              cage2.length, (index) => _resultsAPI(index, cage2[index])),
        ));
  }
}
