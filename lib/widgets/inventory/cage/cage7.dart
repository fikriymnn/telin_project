...
class TableCage7 extends StatefulWidget {
  const TableCage7({super.key});

  @override
  State<TableCage7> createState() => _TableCage7State();
}

class _TableCage7State extends State<TableCage7> {
  List cage7 = [];
  ...
  void getDatareCage7() async {
    try {
      response = await dio.get(getCage7);
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: DataTable2(
          ...
          rows: List.generate(
              cage7.length, (index) => _resultsAPI(index, cage7[index])),
        ));
  }
}
