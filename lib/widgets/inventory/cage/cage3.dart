...
class TableCage3 extends StatefulWidget {
  const TableCage3({super.key});

  @override
  State<TableCage3> createState() => _TableCage3State();
}

class _TableCage3State extends State<TableCage3> {
  List cage3 = [];
  ...
  void getDatareCage3() async {
    try {
      response = await dio.get(getCage3);
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: DataTable2(
          ...
          rows: List.generate(
              cage3.length, (index) => _resultsAPI(index, cage3[index])),
        ));
  }
}
