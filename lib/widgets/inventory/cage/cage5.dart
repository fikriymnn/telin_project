...
class TableCage5 extends StatefulWidget {
  const TableCage5({super.key});

  @override
  State<TableCage5> createState() => _TableCage5State();
}

class _TableCage5State extends State<TableCage5> {
  List cage5 = [];
  ...
  void getDatareCage5() async {
    try {
      response = await dio.get(getCage5);
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: DataTable2(
          ...
          rows: List.generate(
              cage5.length, (index) => _resultsAPI(index, cage5[index])),
        ));
  }
}
