...
class TableCage8 extends StatefulWidget {
  const TableCage8({super.key});

  @override
  State<TableCage8> createState() => _TableCage8State();
}

class _TableCage8State extends State<TableCage8> {
  List cage8 = [];
  ...
  void getDatareCage8() async {
    try {
      response = await dio.get(getCage8);
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: DataTable2(
          ...
          rows: List.generate(
              cage8.length, (index) => _resultsAPI(index, cage8[index])),
        ));
  }
}
