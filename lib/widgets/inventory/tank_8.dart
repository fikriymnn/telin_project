...
class _TableTank8State extends State<TableTank8> {
  ...
  void getDataTank8() async {
    try {
      response = await dio.get(getTank8);
  ...
  Widget build(BuildContext context) {
                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank8[index]['label_id'] == null ? "" : tank8[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank8[index]['system'] == null ? "" : tank8[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank8[index]['armoring_type'] == null ? "" : tank8[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank8[index]['cable_type'] == null ? "" : tank8[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank8[index]['manufacturer'] == null ? "" : tank8[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank8[index]['length_report'] == null ? "" : tank8[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank8[index]['core_type'] == null ? "" : tank8[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank8[index]['core'] == null ? "" : tank8[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank8[index]['tank'] == null ? "" : tank8[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank8[index]['tank_location'] == null ? "" : tank8[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank8[index]['tank_level'] == null ? "" : tank8[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank8[index]['remark'] == null ? "" : tank8[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank8[index]['description'] == null ? "" : tank8[index]['description']}'),
                    },
                  ),
                ),
    ...
    //       ],
    //       rows: List.generate(
    //           tank8.length, (index) => _resultsAPI(index, tank8[index]))),
    // );
  }
}
