...
class TableTank11 extends StatefulWidget {
  const TableTank11({super.key});

  @override
  State<TableTank11> createState() => _TableTank11State();
}

class _TableTank11State extends State<TableTank11> {
  ...
  void getDataTank11() async {
    try {
      response = await dio.get(getTank11);

      setState(() {
        tank11 = response!.data;
      });
    } catch (e) {
                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank11[index]['label_id'] == null ? "" : tank11[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank11[index]['system'] == null ? "" : tank11[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank11[index]['armoring_type'] == null ? "" : tank11[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank11[index]['cable_type'] == null ? "" : tank11[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank11[index]['manufacturer'] == null ? "" : tank11[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank11[index]['length_report'] == null ? "" : tank11[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank11[index]['core_type'] == null ? "" : tank11[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank11[index]['core'] == null ? "" : tank11[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank11[index]['tank'] == null ? "" : tank11[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank11[index]['tank_location'] == null ? "" : tank11[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank11[index]['tank_level'] == null ? "" : tank11[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank11[index]['remark'] == null ? "" : tank11[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank11[index]['description'] == null ? "" : tank11[index]['description']}'),
                    },
                  ),
                ),
