...
class _TableTank4State extends State<TableTank4> {
  ...
  void getDataTank4() async {
    try {
      response = await dio.get(getTank4);
  ...
  Widget build(BuildContext context) {
                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'armoring': PlutoCell(
                          value:
                              '${tank4[index]['armoring_type'] == null ? "" : tank4[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank4[index]['cable_type'] == null ? "" : tank4[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank4[index]['manufacturer'] == null ? "" : tank4[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank4[index]['length_report'] == null ? "" : tank4[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank4[index]['core_type'] == null ? "" : tank4[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank4[index]['core'] == null ? "" : tank4[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank4[index]['tank'] == null ? "" : tank4[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank4[index]['tank_location'] == null ? "" : tank4[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank4[index]['tank_level'] == null ? "" : tank4[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank4[index]['remark'] == null ? "" : tank4[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank4[index]['description'] == null ? "" : tank4[index]['description']}'),
                    },
                  ),
                ),
    ...
    //       ],
    //       rows: List.generate(
    //           tank4.length, (index) => _resultsAPI(index, tank4[index]))),
    // );
  }
}
