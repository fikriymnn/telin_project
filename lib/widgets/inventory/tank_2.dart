...
class _TableTank2State extends State<TableTank2> {
  ...
  void getDataTank2() async {
    try {
      response = await dio.get(getTank2);
  ...
  Widget build(BuildContext context) {
                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank2[index]['label_id'] == null ? "" : tank2[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank2[index]['system'] == null ? "" : tank2[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank2[index]['armoring_type'] == null ? "" : tank2[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank2[index]['cable_type'] == null ? "" : tank2[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank2[index]['manufacturer'] == null ? "" : tank2[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank2[index]['length_report'] == null ? "" : tank2[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank2[index]['core_type'] == null ? "" : tank2[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank2[index]['core'] == null ? "" : tank2[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank2[index]['tank'] == null ? "" : tank2[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank2[index]['tank_location'] == null ? "" : tank2[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank2[index]['tank_level'] == null ? "" : tank2[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank2[index]['remark'] == null ? "" : tank2[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank2[index]['description'] == null ? "" : tank2[index]['description']}'),
                    },
                  ),
                ),
    ...
    //       ],
    //       rows: List.generate(
    //           tank2.length, (index) => _resultsAPI(index, tank2[index]))),
    // );
  }
}
