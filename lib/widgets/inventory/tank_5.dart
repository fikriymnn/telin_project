...
class TableTank5 extends StatefulWidget {
  const TableTank5({super.key});

  @override
  State<TableTank5> createState() => _TableTank5State();
}

class _TableTank5State extends State<TableTank5> {
  ...
  void getDataTank5() async {
    try {
      response = await dio.get(getTank5);
  ...
  Widget build(BuildContext context) {
                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank5[index]['label_id'] == null ? "" : tank5[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank5[index]['system'] == null ? "" : tank5[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank5[index]['armoring_type'] == null ? "" : tank5[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank5[index]['cable_type'] == null ? "" : tank5[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank5[index]['manufacturer'] == null ? "" : tank5[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank5[index]['length_report'] == null ? "" : tank5[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank5[index]['core_type'] == null ? "" : tank5[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank5[index]['core'] == null ? "" : tank5[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank5[index]['tank'] == null ? "" : tank5[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank5[index]['tank_location'] == null ? "" : tank5[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank5[index]['tank_level'] == null ? "" : tank5[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank5[index]['remark'] == null ? "" : tank5[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank5[index]['description'] == null ? "" : tank5[index]['description']}'),
                    },
                  ),
                ),
    ...
    //       ],
    //       rows: List.generate(
    //           tank5.length, (index) => _resultsAPI(index, tank5[index]))),
    // );
  }
}
