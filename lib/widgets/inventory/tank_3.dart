                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank3[index]['label_id'] == null ? "" : tank3[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank3[index]['system'] == null ? "" : tank3[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank3[index]['armoring_type'] == null ? "" : tank3[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank3[index]['cable_type'] == null ? "" : tank3[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank3[index]['manufacturer'] == null ? "" : tank3[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank3[index]['length_report'] == null ? "" : tank3[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank3[index]['core_type'] == null ? "" : tank3[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank3[index]['core'] == null ? "" : tank3[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank3[index]['tank'] == null ? "" : tank3[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank3[index]['tank_location'] == null ? "" : tank3[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank3[index]['tank_level'] == null ? "" : tank3[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank3[index]['remark'] == null ? "" : tank3[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank3[index]['description'] == null ? "" : tank3[index]['description']}'),
                    },
                  ),
                ),
