...
class _TableTank10State extends State<TableTank10> {
  ...
  Widget build(BuildContext context) {
                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank10[index]['label_id'] == null ? "" : tank10[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank10[index]['system'] == null ? "" : tank10[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank10[index]['armoring_type'] == null ? "" : tank10[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank10[index]['cable_type'] == null ? "" : tank10[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank10[index]['manufacturer'] == null ? "" : tank10[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank10[index]['length_report'] == null ? "" : tank10[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank10[index]['core_type'] == null ? "" : tank10[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank10[index]['core'] == null ? "" : tank10[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank10[index]['tank'] == null ? "" : tank10[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank10[index]['tank_location'] == null ? "" : tank10[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank10[index]['tank_level'] == null ? "" : tank10[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank10[index]['remark'] == null ? "" : tank10[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank10[index]['description'] == null ? "" : tank10[index]['description']}'),
                    },
                  ),
                ),
    ...
    //       ],
    //       rows: List.generate(
    //           tank10.length, (index) => _resultsAPI(index, tank10[index]))),
    // );
  }
}
