                ...
                rows: List.generate(
                  ...
                  (index) => PlutoRow(
                    cells: {
                      ...
                      'lable': PlutoCell(
                          value:
                              '${tank9[index]['label_id'] == null ? "" : tank9[index]['label_id']}'),
                      'system': PlutoCell(
                          value:
                              '${tank9[index]['system'] == null ? "" : tank9[index]['system']}'),
                      'armoring': PlutoCell(
                          value:
                              '${tank9[index]['armoring_type'] == null ? "" : tank9[index]['armoring_type']}'),
                      'cable_type': PlutoCell(
                          value:
                              '${tank9[index]['cable_type'] == null ? "" : tank9[index]['cable_type']}'),
                      'manufacturer': PlutoCell(
                          value:
                              '${tank9[index]['manufacturer'] == null ? "" : tank9[index]['manufacturer']}'),
                      'length': PlutoCell(
                          value:
                              '${tank9[index]['length_report'] == null ? "" : tank9[index]['length_report']}'),
                      'core_type': PlutoCell(
                          value:
                              '${tank9[index]['core_type'] == null ? "" : tank9[index]['core_type']}'),
                      'core': PlutoCell(
                          value:
                              '${tank9[index]['core'] == null ? "" : tank9[index]['core']}'),
                      'tank': PlutoCell(
                          value:
                              '${tank9[index]['tank'] == null ? "" : tank9[index]['tank']}'),
                      'tank_location': PlutoCell(
                          value:
                              '${tank9[index]['tank_location'] == null ? "" : tank9[index]['tank_location']}'),
                      'tank_level': PlutoCell(
                          value:
                              '${tank9[index]['tank_level'] == null ? "" : tank9[index]['tank_level']}'),
                      'remark': PlutoCell(
                          value:
                              '${tank9[index]['remark'] == null ? "" : tank9[index]['remark']}'),
                      'description': PlutoCell(
                          value:
                              '${tank9[index]['description'] == null ? "" : tank9[index]['description']}'),
                    },
                  ),
                ),
